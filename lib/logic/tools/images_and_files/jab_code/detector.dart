...
//     int state_count[5] = {0};
//
//     int centerx_int = (int)centerx;
// 	int centery_int = (int)(*centery);
//     int i, state_index;
//
//     state_count[1]++;
...
*/
jab_data decodeJABCodeEx(jab_bitmap bitmap, int mode, int status, List<jab_decoded_symbol> symbols, int max_symbol_number)
{
