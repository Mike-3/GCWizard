...
class _GCWColorValuesPickerState extends State<_GCWColorValuesPicker> {
  ...
  Widget build(BuildContext context) {
    ...
    final Map<ColorSpaceKey, Widget> _colorWidgets = {
      ColorSpaceKey.RGB: _GCWColorRGB(
      ...
      ColorSpaceKey.HEXCODE: _GCWColorHexCode(
      ...
      ColorSpaceKey.HSL: _GCWColorHSL(
      ...
      ColorSpaceKey.HSI: _GCWColorHSI(
      ...
      ColorSpaceKey.CMYK: _GCWColorCMYK(
      ...
      ColorSpaceKey.CMY: _GCWColorCMY(
      ...
      ColorSpaceKey.YUV: _GCWColorYUV(
      ...
      ColorSpaceKey.YPBPR: _GCWColorYPbPr(
      ...
      ColorSpaceKey.YCBCR: _GCWColorYCbCr(
      ...
      ColorSpaceKey.YIQ: _GCWColorYIQ(
